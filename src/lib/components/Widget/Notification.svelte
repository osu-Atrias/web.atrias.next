<script lang="ts">
    ...
    import { NotificationType } from "../../modules/notification";
    import Time from "svelte-time";
    import { removeNotificationAtPosition } from "../../modules/notification";
...
<div class="flex flex-col justify-center">
    {#if type === NotificationType.Info}
        ...
        >
            <div
                class="bg-blue-600 flex justify-between items-center py-2 px-3 bg-clip-padding border-b border-blue-500 rounded-t-lg"
            >
                <p class="font-bold text-white flex items-center mb-0">
                    <svg
                        aria-hidden="true"
                        focusable="false"
                        data-prefix="fas"
                ...
                <div class="flex items-center">
                    <p class="text-white opacity-90 text-xs mb-0">
                        <Time live relative />
                    </p>
                    <button
                        type="button"
                        ...
                        aria-label="Close"
                        on:click={() => removeNotificationAtPosition(index)}
                    />
                </div>
            </div>
    ...
    {:else if type === NotificationType.Warning}
        ...
        >
            <div
                class="bg-yellow-500 flex justify-between items-center py-2 px-3 bg-clip-padding border-b border-yellow-400 rounded-t-lg"
            >
                <p class="font-bold text-white flex items-center mb-0">
                    <svg
                        aria-hidden="true"
    ...
    {:else if type === NotificationType.Error}
        ...
        >
            <div
                class="bg-red-600 flex justify-between items-center py-2 px-3 bg-clip-padding border-b border-red-400 rounded-t-lg"
            >
                <p class="font-bold text-white flex items-center mb-0">
                    <svg
                        aria-hidden="true"
